          ...
          <div className="left-container">
            <div className="product">
              ...
              <div className="product-box">
                <div className="product-name">{this.state.detailData.name}</div>
                  ...
                  <div className="quantity">
                    ...
                    <div className="control">
                      <button
                        ...
                        style={{
                          cursor:
                            this.state.count === 1 ? "not-allowed" : "pointer",
                          color:
                            this.state.count === 1
                              ? "rgb(203, 203, 203)"
                              : "black",
                      ...
                      <button
                        ...
                        style={{
                          cursor:
                            this.state.count === 4 ? "not-allowed" : "pointer",
                          color:
                            this.state.count === 4
                              ? "rgb(203, 203, 203)"
                              : "black",
            ...
            <div className="order-box">
              ...
              <div className="total-box">
                ...
                <div className="notice">
                  ...
                  <p>
                    Read more in our <a href="#!">returns and refund policy.</a>
                  </p>
                </div>
              </div>
            </div>
